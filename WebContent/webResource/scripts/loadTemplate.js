(function ($) {
    ...
    function loadTemplate(template, data, options) {
        var $that = this,   //this就是调用这个的函数的dom
            $template,
            isFile,
            settings;
        data = data || {};
    ...
    function bindData(template, data, settings) {
        ...
        * 自定义
        */
        processElements("data-display", template, data, settings, function ($elem, value) {
            if(value == false) {    //隐藏
                $elem.remove();
            }
        }, function($elem) {
        ...
        processElements("data-background", template, data, settings, function ($elem, value) {
